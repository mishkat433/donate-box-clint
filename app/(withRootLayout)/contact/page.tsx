        ...
        <div className="container mx-auto ">
            <div className="flex flex-col md:flex-row  gap-4 justify-between items-center my-5 md:my-14 p-2">
                <div className="w-full md:w-1/2  text-primary-text">
                    ...
                    <p className=" mt-2 text-sm text-justify"><i className="font-semibold">&#91;Note : </i>Your privacy is important to us. We will not share your information with third parties, and it will only be used to respond to your inquiry.&#93;</p>
