...
const TabMenu = ({ type, setType }) => {
    return (
        <div role="tablist" className="tabs tabs-lifted p-2 sticky top-11 z-10 bg-white-text">
            ...
            <a role="tab" onClick={() => setType('fund')} className={`tab font-medium  ${type === 'fund' && 'tab-active [--tab-bg:#C30047] [--tab-border-color:#C30047] text-white-text '}`}>Donate Fund </a>
