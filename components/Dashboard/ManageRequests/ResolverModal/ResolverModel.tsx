                ...
                <div className='my-3 rounded-md mx-auto shadow-md border-1 border-border-color p-2'>
                    <Form submitHandler={onSubmit} resolver={yupResolver(assignDonnerSchema)} >
                        ...
                        <div className='flex w-full gap-3'>
                            ...
                            <label htmlFor="requestResolver" className="w-full"><button className="button-transition primary-red-button w-full py-2 px-2.5 "> Send Request</button></label>
                        </div>
                    </Form >
                </div>
                :
                <ViewRequest nextHandle={setNextHandle} />
            }
        </ >
    );
};
