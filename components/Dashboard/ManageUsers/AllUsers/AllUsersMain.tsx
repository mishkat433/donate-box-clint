...
import { RiUserAddLine, RiUserSmileFill, RiFilePdf2Line } from "react-icons/ri";
        ...
        <div className="">
            <div className=" flex justify-between items-center gap-4 mb-4">
                ...
                <div className=" flex items-center gap-4 ">
                    <button className="p-1.5 primary-red-button flex items-center gap-1"><RiFilePdf2Line /> Download PDF</button>
