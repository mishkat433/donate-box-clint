import { RiArrowDownSFill, RiDeleteBack2Line, RiDeleteBinLine, RiEdit2Line, RiEyeLine, RiVerifiedBadgeLine } from "react-icons/ri";
...
const CommonTable = ({ columns, data, bannedHandler, deleteHandler, slCount }: tableType) => {
    ...
    return (
        <div className="overflow-x-auto">
            ...
            <Modal id="userDetailsView" title="User Details">
              <ViewUser userData={modalData}/>
            </Modal>
